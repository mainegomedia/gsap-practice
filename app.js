...
// gsap.from('.links', {duration: 1, opacity: 0, delay: 1, stagger: 1})

// gsap.from('.right', {duraction: 1, x: '-100vw', delay: 1, ease: 'power2.in' })

// gsap.from('.left', {duraction: 1, x: '-100%', delay: 2, ease: 'power2.in' })
